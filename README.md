...
## How to crawl comments of a post (comments.py)
...
The use is similar to fb spider, the only difference being the -a page parameter, which now is the link to a post. Make sure that the `post` option is a proper post link, for example:
